      ...
      <div class="flex space-x-6 text-sm text-gray-700">
        ...
        ${
          isAuthenticated
            ? `
              <!-- 마이페이지 -->
              <a href="#/mypage" class="group hover:text-green-600 flex flex-col items-center justify-center text-gray-700">
              ...
              <div class="flex items-center space-x-3">
                <div class="text-sm text-gray-700">
                  ...
                  <div class="h-8 flex justify-end">
                    ...
                    <button onclick="handleLogoutAndReload()" class="p-[5px] ml-2 text-xs font-bold text-white bg-black rounded-md border-2 border-transparent hover:text-black hover:bg-white hover:border-black transition-colors">
                      로그아웃
                    </button>
                  </div>
                </div>
